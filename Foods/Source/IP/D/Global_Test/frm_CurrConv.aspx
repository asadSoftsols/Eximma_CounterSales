<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_CurrConv.aspx.cs" Inherits="Foods.Source.IP.D.Global_Test.frm_CurrConv" %>
...
<table class="main">
        <tr>
            <th colspan="2">
                Realtime Currency Converter ASP.NET Yahoo API
            </th>
        </tr>
        <tr>
            <td>
    ...
    </table><asp:Label ID="Label1" runat="server"></asp:Label>
