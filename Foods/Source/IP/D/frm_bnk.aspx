<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
     CodeBehind="frm_bnk.aspx.cs" Inherits="Foods.Source.IP.D.frm_bnk" %>
      ...
      <%--    <asp:UpdatePanel  ID="UpdatePanel1" runat="server">
        <ContentTemplate>  
            ...
            <ul class="breadcrumb">
				...
				<li><a href="frm_Area.aspx">Bank</a></li>
			</ul>
					...
					<div class="box-content">
                        ...
                        <div class="row-fluid sortable">		
	                         <div class="box span12">
				                ...
				                <div class="box-content">
                                    <asp:GridView ID="GVArea" runat="server" AutoGenerateColumns="False" AllowPaging="true" PageSize="5" DataKeyNames="CashBnk_id" CssClass="table table-striped table-bordered" OnRowCommand="GVArea_RowCommand" OnPageIndexChanging="GVArea_PageIndexChanging" OnRowDeleting="GVArea_RowDeleting">
                                        <Columns>
                                            <asp:BoundField DataField="CashBnk_id" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="CashBnk_id" />
                                            <asp:BoundField DataField="CashBnk_nam" HeaderText="Bank Name" SortExpression="area_" />
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    ...
                                                    <asp:HiddenField ID="hfbnkid" runat="server" Value='<%# Eval("CashBnk_id")%>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
    ...
    <div id="myModal" class="modal fade" style="display:none;">
			  <div class="modal-dialog">
				<div class="modal-content">
                    ...
                    <tr>
                        <td class="span3">
                            <asp:Label ID="lbl_Area" runat="server">Bank</asp:Label>
                        </td>
                        <td class="span8">
                            <asp:TextBox ID="TBbnk" runat="server"></asp:TextBox>
                            <asp:Label ID="v_bank" runat="server" Font-Bold="true" ForeColor="Red" Text=""></asp:Label>
                        </td>
                    </tr>
                </table>
					</div>
				  <!-- dialog buttons -->
                    ...
                    <asp:HiddenField ID="HFbnkid" runat="server" />
				</div>
			  </div>
			</div>
