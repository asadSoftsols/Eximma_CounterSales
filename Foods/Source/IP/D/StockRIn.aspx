<%@ Page Title="Rejected Stock" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="StockRIn.aspx.cs" Inherits="Foods.StockRIn" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <a href="StockRIn.aspx">Rejected Stock</a>            
        </li>
    </ul>
    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon align-justify"></i><span class="break"></span> Stock of Rejected </h2>
                <div class="box-icon">
