    ...
    <div>
            ...
            <div class="clear"></div>
                <fieldset>
                    ...
                    <br />
                    <div class="gv">
                        <asp:GridView ID="GV_ProSale" runat="server" EmptyDataText="No Record Found!" 
                            ...
                            <Columns>
                               ...
                               <%-- <asp:BoundField DataField="DSal_ItmQty" HeaderText="Quantity" SortExpression="DSal_ItmQty" />
                                ...
                                <asp:BoundField DataField="DSal_ItmUnt" HeaderText="Units" SortExpression="DSal_ItmUntl" />                                
                                <asp:BoundField DataField="rat" HeaderText="Rate" SortExpression="rat" />
                               <%-- <asp:BoundField DataField="Dis" HeaderText="Discount" SortExpression="Dis" />
                                <asp:BoundField DataField="Amt" HeaderText ="Amount" SortExpression="Amt" />--%>
                                <asp:TemplateField HeaderText="TotaL">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_GTtl" runat="server" Text='<%# Eval("TtlAmt")%>' ></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
