                ...
                if (Id == null)
                {
                    using (SqlCommand cmd = new SqlCommand())
                    {
                        ...
                        if (dt_.Rows.Count > 0)
                        {
                            ...
                            string billno = dt_.Rows[0]["MPurID"].ToString();
                        ...
                        query = " select PaymentOut,prevbal,typeofpay,accno from tbl_expenses where billno='" + lbl_vouc.Text + "' and CompanyId = '" + Session["CompanyID"] + "' and BranchId= '" + Session["BranchID"] + "'";
                        ...
                        if (dt_.Rows.Count > 0)
                        {
                            lbl_cashtype.Text = dt_.Rows[0]["typeofpay"].ToString();
                            lbl_prevbal.Text = dt_.Rows[0]["prevbal"].ToString();
                            lbl_amtpad.Text = dt_.Rows[0]["PaymentOut"].ToString();
                        }
                    }
