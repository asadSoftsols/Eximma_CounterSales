...
<body>
    ...
    <div id="container">
            <div class="uppper">
                <h1>Abaseen Chicken Center</h1>
                <h2>Sales Report Month Wise</h2>
            </div>
            <div class="left">
                Month: <asp:Label ID="lbl_mon" runat="server" Text="-" ></asp:Label><br />
                Year: <asp:Label ID="lbl_yr" runat="server" Text="-"></asp:Label><br />
            </div>
            <div class="right">
            ...
            <div class="clear"></div>
                <fieldset>
                    ...
                    <br />
                    <div class="gv">
                        <asp:GridView ID="GV_Month" runat="server" ShowFooter="true" EmptyDataText="No Record Found!" ShowHeaderWhenEmpty="true"
                             ShowHeader="true" AutoGenerateColumns="False" style="width:100%; height:auto;"
                             DataKeyNames="MSal_id,DSal_id" >
                            <Columns>
                                ...
                                <asp:BoundField DataField="DSal_ItmUnt" HeaderText="Units" SortExpression="DSal_ItmUnt" />                                
