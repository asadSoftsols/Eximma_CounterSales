    ...
    public partial class rpt_monwis : System.Web.UI.Page
    {
        ...
        private void get_monsal(string Monid, string year)
        {
            try
            {
                ...
                {
                    cmd.CommandText = "select * from v_rptSal where [Month] = '" + Monid + "' and YEAR(Saldat)= '" + year + "' and CompanyId='" + Session["CompanyID"] + "' and BranchId='" + Session["BranchID"] + "'";
                    //cmd.CommandText = "select * from v_rptDSal where [Month] = '" + Monid + "' and [YEAR]= '" + year + "' and CompanyId='" + Session["CompanyID"] + "' and BranchId='" + Session["BranchID"] + "'";
                    cmd.Connection = con;
                    con.Open();
