...
<body>
    <form id="form1" runat="server">
	        ...
	        <div class="content">
		        ...
		        <br/>
		        <div id="Main">
                    <asp:GridView ID="GVShowpurItms" CssClass="table" style="text-align:center;" runat="server"
                         EmptyDataText="Sorry No Record Exits" AutoGenerateColumns="false" DataKeyNames="MPurID,ProductID" >
                        <Columns>
                ...
                <table style="width:200px; height:auto; float:right">
				    ...
				    <tr>
                      ...
                      <tr style="visibility:hidden" >
					    ...
					    <td style="border-bottom:1px solid #000">
                            <asp:Label ID="lbl_amtpad" runat="server" Text="0"></asp:Label>
					    </td>
				    </tr>
                     <tr style="visibility:hidden" >
					    <td><label>Payment Type:</label></td>
					    <td style="border-bottom:1px solid #000">
                            <asp:Label ID="lbl_cashtype" runat="server" Text="0"></asp:Label>
					    </td>
				    </tr>		
                    <tr style="visibility:hidden" >
					    <td><label>Previous Bal:</label></td>
					    <td style="border-bottom:1px solid #000">
                            <asp:Label ID="lbl_prevbal" runat="server" Text="0"></asp:Label>
					    </td>
				    </tr>				
