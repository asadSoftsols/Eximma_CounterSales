...
namespace Foods
{
    public partial class rpt_Rstk : System.Web.UI.Page
    {
        ...
        public void FillGrid(string rej, string stkrej)
        {
            try
            {
                q = " select * from  v_stk where  ProductID= '" + rej + "' and Dstk_unt ='" + stkrej + "' and returntyp='Defected' and CompanyId = '" + Session["CompanyID"] + "' and BranchId= '" + Session["BranchID"] + "'";
        ...
        public void FillGrid(string REJSTK)
        {
            try
            {
                q = " select * from  v_stk  where  Dstk_unt='" + REJSTK + "' and returntyp='Defected' and CompanyId = '" + Session["CompanyID"] + "' and BranchId= '" + Session["BranchID"] + "'";
        ...
        public void FillGrid()
        {
            try
            {
                q = " select * from  v_stk  where  returntyp='Defected' and CompanyId = '" + Session["CompanyID"] + "' and BranchId= '" + Session["BranchID"] + "'";
