            ...
            <div id="Div1">
	            ...
	            <div class="content">
		            ...
		            <br/>
                     <%--CommandName="Detail"--%>
		            <div id="Main">
                        <asp:GridView ID="GVProf" runat="server" AutoGenerateColumns="False" CssClass="grid" DataKeyNames="MSal_id,ProductID" OnRowCommand="GVProf_RowCommand" >
                            <Columns>
                                <asp:TemplateField HeaderText="Product">
                                    <ItemTemplate>
                                        <asp:Label ID="lnk_pro" runat="server"  Text='<%# Eval("productname")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="DSal_ItmUnt" HeaderText="Size" SortExpression="DSal_ItmUnt" />
                                <asp:TemplateField HeaderText="Sale Invoice No">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_salid" runat="server" Text='<%# Eval("MSal_sono")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Amount After Dis">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_amtaftdisc" runat="server" Text='<%# Eval("AmountAFterDis")%>'></asp:Label>
                                    </ItemTemplate> 
                                </asp:TemplateField>
