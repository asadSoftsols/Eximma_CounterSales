...
namespace Foods
{
    public partial class rpt_custcrdt : System.Web.UI.Page
    {
        ...
        private void get_custcre(string fdat, string ldat, string crbkr, string crsal, string crcust, string crarea, string crbil)
        {
            using (SqlCommand cmd = new SqlCommand())
            {
                cmd.CommandText = "	select * from v_credtcustwis where CreatedAt between '" + fdat + "' and '" + ldat + "'" +
                    "	and Booker='" + crbkr + "' and SalMan='" + crsal + "' and CustomerID='" + crcust + "' and areaid='" + crarea + "' and " +
                    "	MSal_sono = '" + crbil + "' and CompanyId = '" + Session["CompanyID"] + "' and BranchId= '" + Session["BranchID"] + "'";
        ...
        private void get_custcre(string fdat, string ldat, string crbkr, string crsal, string crcust, string crarea)
        {
            using (SqlCommand cmd = new SqlCommand())
            {
                cmd.CommandText = "	select * from v_credtcustwis where CreatedAt between '" + fdat + "' and '" + ldat + "'" +
                    "	and Booker='" + crbkr + "' and SalMan='" + crsal + "' and CustomerID='" + crcust + "' and areaid='" + crarea + "' and CompanyId = '" + Session["CompanyID"] + "' and BranchId= '" + Session["BranchID"] + "'";
        ...
        private void get_custcre(string fdat, string ldat, string crbkr, string crsal, string crcust)
        {
            using (SqlCommand cmd = new SqlCommand())
            {
                cmd.CommandText = "	select * from v_credtcustwis where CreatedAt between '" + fdat + "' and '" + ldat + "'" +
                    "	and Booker='" + crbkr + "' and SalMan='" + crsal + "' and CustomerID='" + crcust + "' and CompanyId = '" + Session["CompanyID"] + "' and BranchId= '" + Session["BranchID"] + "'";
        ...
        private void get_custcre(string fdat, string ldat, string crbkr, string crsal)
        {
            using (SqlCommand cmd = new SqlCommand())
            {
                cmd.CommandText = "	select * from v_credtcustwis where CreatedAt between '" + fdat + "' and '" + ldat + "'" +
                    "	and Booker='" + crbkr + "' and SalMan='" + crsal + "' and CompanyId = '" + Session["CompanyID"] + "' and BranchId= '" + Session["BranchID"] + "'";
        ...
        private void get_custcre(string fdat, string ldat, string crbkr)
        {
            using (SqlCommand cmd = new SqlCommand())
            {
                cmd.CommandText = "	select * from v_credtcustwis where CreatedAt between '" + fdat + "' and '" + ldat + "'" +
                    "	and Booker='" + crbkr + "' and and CompanyId = '" + Session["CompanyID"] + "' and BranchId= '" + Session["BranchID"] + "'";
        ...
        private void get_custcre(string fdat, string ldat)
        {
            using (SqlCommand cmd = new SqlCommand())
            {
                cmd.CommandText = "	select * from v_credtcustwis where CreatedAt between '" + fdat + "' and '" + ldat + "' and CompanyId = '" + Session["CompanyID"] + "' and BranchId= '" + Session["BranchID"] + "'";
