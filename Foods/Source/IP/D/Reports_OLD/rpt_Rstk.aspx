<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rpt_Rstk.aspx.cs" Inherits="Foods.rpt_Rstk" %>
	        ...
	        <div class="content">
                ...
                <asp:GridView ID="GVStk" runat="server" AutoGenerateColumns="false" class="gv" EmptyDataText="NO Record Found" ShowHeader="true" ShowHeaderWhenEmpty="true" >
                    <Columns>                    
                        ...
                        <asp:BoundField DataField="dstkdef" HeaderText="Qty" SortExpression="dstkdef" />
                        <asp:BoundField DataField="Dstk_rat" HeaderText="Rate" SortExpression="Dstk_rat" />
                        <asp:TemplateField HeaderText="Stock Value">
                            <ItemTemplate>
                                <asp:Label ID="lbl_stkval" runat="server" Text='<%# Eval("DefStk") %>' ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>  
                </asp:GridView>
