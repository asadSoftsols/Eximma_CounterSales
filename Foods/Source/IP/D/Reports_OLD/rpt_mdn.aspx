	        ...
	        <div class="content">
                ...
                <asp:GridView ID="GVSal" runat="server" AutoGenerateColumns="False" CssClass="grid" DataKeyNames="Mdn_id" >
                    <Columns>
                        ...
                        <asp:BoundField DataField="Ddn_ItmDes" HeaderText="Description" Visible="false" SortExpression="Ddn_ItmDes" />
                        <asp:BoundField DataField="Ddn_ItmQty" HeaderText="Qty" ReadOnly="True" SortExpression="Ddn_ItmQty" />
                        <asp:BoundField DataField="Ddn_ItmUnt" HeaderText="Size" ReadOnly="True" SortExpression="Ddn_ItmUnt" />
