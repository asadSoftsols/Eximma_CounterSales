	        ...
	        <div class="content">
                ...
                <asp:GridView ID="GVSal" runat="server" AutoGenerateColumns="False" CssClass="grid" DataKeyNames="MSal_id" >
                    <Columns>
                        ...
                        <asp:BoundField DataField="Products" HeaderText="Size / Description" ReadOnly="True" SortExpression="Products" />
                        <asp:BoundField DataField="DSal_ItmUnt" HeaderText="Size" ReadOnly="True" SortExpression="DSal_ItmUnt" />
                        ...
                        <asp:TemplateField HeaderText="Net Amount">
                            <ItemTemplate>
                                <asp:Label ID="lbl_afterdis" runat="server"  Text='<%# Eval("NetAmt")%>' ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
                ...
                <div class="right">                    
                    <table style="width:200px; height:auto; border:0px; float:right; margin-right:30px;" border="0">
                        <tr>
                            <td>Gross Amount:  <asp:Label ID="lbl_grrsttl" runat="server" ></asp:Label> Only-</td>
                        </tr>
                        <tr>
                            <td>Discount:  <asp:Label ID="lbldisc" runat="server" ></asp:Label> %</td>
                        </tr>     
                        <tr>
                            <td>Discount Amount:  <asp:Label ID="lbldiscamt" runat="server" ></asp:Label> Only-</td>
                        </tr>
                        <tr>
                            <td>Current Net Payable:  <asp:Label ID="lb_currnetpay" runat="server" ></asp:Label> Only</td>
                        </tr>                        
                        <tr>
                            <td>Previous Outstanding: <asp:Label ID="lb_preout" runat="server" ></asp:Label> Only-</td>
                        </tr>
                    </table>
                </div>		
		        <br />
