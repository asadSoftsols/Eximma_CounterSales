...
<body>
    ...
    <div>
	            ...
	            <div class="content">
		            ...
		            <br/>
		            <div id="Main">
                        <asp:GridView ID="GVProf" runat="server" ShowHeader="true" ShowHeaderWhenEmpty="true"
                             EmptyDataText="No Record Found.." AutoGenerateColumns="False" CssClass="grid" DataKeyNames="accno" >
                            <Columns>
