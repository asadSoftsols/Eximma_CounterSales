            ...
            try
            {
                ...
                using (var cmd = new SqlCommand("sp_cshbook", con))
                {
                    ...
                    if (dt_.Rows.Count > 0)
                    {
                        ...
                        if (dt_.Rows.Count > 0)
                        {
                            OpenBal = dt_.Rows[0]["OpeningBalance"].ToString();
                            ...
                            else if (OpenBal != "" || OpenBal != "0" || OpenBal != null)
                            {
                                ...
                                lbl_Openbalance.Text = dt_.Rows[0]["OpeningBalance"].ToString();
                            }

                            lbl_ClsBal.Text = dt_.Rows[0]["OpeningBalance"].ToString();
                        ...
                        if (dt_.Rows.Count > 0)
                        {
                            currbal = dt_.Rows[0]["OpeningBalance"].ToString();

                            TBOpeBal.Text = dt_.Rows[0]["OpeningBalance"].ToString();
                            lbl_Openbalance.Text = dt_.Rows[0]["OpeningBalance"].ToString();
