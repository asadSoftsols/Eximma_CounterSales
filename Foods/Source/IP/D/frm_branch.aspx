					...
					<div class="modal-body">
					 <table class="table span12">
                        ...
                        <tr>
                         ...
                         <tr>
                            <td class="span3">
                                <asp:Label ID="lbl_brnchlogo" runat="server">Upload Logo</asp:Label>
                            </td>
                            <td class="span8">
                                <asp:FileUpload ID="FUp_logo" runat="server" />
                                <br />
                                <asp:Image ID="imgViewFile" runat="server" AlternateText="logo" Width="200" Height="200" />
                            </td>
                        </tr>
                        <tr>
                            <td class="span3">
                        ...
                        <tr>
                          ...
                          <tr>
                            <td class="span3">
                                <asp:Label ID="lbl_Mob" runat="server">Mobile No</asp:Label>
                            </td>
                            <td class="span8">
                                <asp:TextBox ID="TBMobNo" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="span3">
