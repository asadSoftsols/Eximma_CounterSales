<%@ Page Title="Currency" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="frm_curr.aspx.cs" Inherits="Foods.frm_curr" %>
...
<%--    <asp:UpdatePanel  ID="UpdatePanel1" runat="server">
        <ContentTemplate>  
            ...
            <ul class="breadcrumb">
				...
				<li><a href="frm_curr.aspx">Currency</a></li>
			</ul>
           <div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon align-justify"></i><span class="break"></span>Currency</h2>
						<div class="box-icon">
						</div>
					</div>
					<div class="box-content">
                        ...
                        <div class="control-group  span12">
							...
							<div class="controls">
                                 <div class="input-append span6">
                                       <asp:TextBox ID="TBSearchCurrency" runat="server" size="16" /><asp:Button ID="SeacrhBtn"  runat="server" CssClass="btn" Text="GO!" OnClick="SeacrhBtn_Click" />
    						    </div>
                        ...
                        <div class="row-fluid sortable">		
	                         <div class="box span12">
				                <div class="box-header" data-original-title>
					                <h2><i class="halflings-icon align-justify"></i><span class="break"></span>Currency List</h2>
					                <div class="box-icon">
				                ...
				                <div class="box-content">
                                    <asp:GridView ID="GVCurrency" runat="server" AutoGenerateColumns="False" AllowPaging="true" PageSize="5" DataKeyNames="Curr_id" CssClass="table table-striped table-bordered" OnRowCommand="GVCurrency_RowCommand" OnPageIndexChanging="GVCurrency_PageIndexChanging" OnRowDeleting="GVCurrency_RowDeleting">
                                        <Columns>
                                            <asp:BoundField DataField="Curr_id" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="Curr_id" />
                                            <asp:BoundField DataField="Curr_nam" HeaderText="Currency" SortExpression="Curr_nam" />
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    ...
                                                    <asp:HiddenField ID="HFCurrID" runat="server" Value='<%# Eval("Curr_id")%>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
			  ...
			  <div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Add/Edit Currency</h4>
					</div>
					<!-- dialog body -->
                    ...
                    <tr>
                        ...
                        <td class="span8">
                            <asp:TextBox ID="TBCurrency" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                </table>
					</div>
				  <!-- dialog buttons -->
					<div class="modal-footer">
                            <asp:Button ID="BtnCreateCurrency" runat="server" CssClass="btn btn-success" Text="Create" OnClick="BtnCurrency_Click" />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="BtnCancelCategory" runat="server" CssClass="btn btn-danger" Text="Cancel"  OnClick="BtnCurrency_Click" OnClientClick="show();" />
    ...
    <%--<asp:Button ID="BtnCancelCategory" runat="server" CssClass="btn btn-danger" Text="Cancel"  OnClick="BtnCancelfrm_currClick" OnClientClick="show();" />--%>						
</asp:Content>
