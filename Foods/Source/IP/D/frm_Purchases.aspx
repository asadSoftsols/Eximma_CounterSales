<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="frm_Purchases.aspx.cs" Inherits="Foods.frm_Purchases" %>
                        ...
                        <div class="box-content">                                 
                            <div class="span1">
                                <div class="control-group">
                                    <label class="control-label" for="TBSearchPONum">ID</label>
                                </div>
                            </div>
                            <div class="span10">
                                <div class="controls">
                                    <div class="input-append">
                                        <asp:TextBox runat="server" class="span12" ID="TBSearchPONum" AutoPostBack="true"  ></asp:TextBox><asp:LinkButton runat="server" ID="LinkButton1" CssClass="add-on" ><i class="icon-search"></i></asp:LinkButton>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="controls">
                                    <div>
                                        <asp:GridView ID="GVScrhMPur" runat="server" class="table table-striped table-bordered"
                                             AllowPaging="True" PageSize="4" AutoGenerateColumns="False" DataKeyNames="MPurID" >
                                            <Columns>
                                ...
                                <div class="span1">&nbsp;</div>
                                    ...
                                    <div class="span12">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <asp:DropDownList id="DDL_VenAcc" runat="server" data-rel="chosen" CssClass="span4" AutoPostBack="true" ></asp:DropDownList>                                           
                                                <asp:DropDownList id="ddlVenNam" runat="server" data-rel="chosen" CssClass="span6"  AutoPostBack="True" ></asp:DropDownList>                                           
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <asp:Panel ID="pnlvtyp" runat="server">
                                        <div class="span6" >
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <asp:DropDownList ID="DDL_Vchtyp" runat="server" data-rel="chosen" CssClass="span12" AutoPostBack="True">                                               
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="span5" >
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <asp:DropDownList ID="DDL_Paytyp" runat="server" data-rel="chosen" CssClass="span12" AutoPostBack="True">                                               
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="span5">
                                            <div class="span12">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <asp:DropDownList id="DDL_Currency" runat="server" data-rel="chosen" CssClass="span12" AutoPostBack="True" ></asp:DropDownList>                                           
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="span2">
                                            <div class="span12">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <asp:Button ID="btn_CurrSav" runat="server" Text="Save" CssClass="btn btn-primary" /></div>  
                                                    </div>
                                                </div>
                                            </div> 
                                        </div>
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Category">  
                                                <ItemTemplate>
                                                   ...
                                                   <asp:TextBox ID="TBcat" runat="server" Text='<%# Eval("Category") %>' placeholder="Category..."  style="width:80px; height:20px; background:none; border:none;"  AutoPostBack="true"  ></asp:TextBox>
                                            ...
                                            <asp:TemplateField HeaderText="Description">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="TbItmDscptin" Text='<%# Eval("Description")%>' runat="server" placeholder="Description..."  style="width:120px; height:20px; background:none; border:none;" AutoPostBack="true"></asp:TextBox>
                                            ...
                                            <asp:TemplateField HeaderText="Brand">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="Tbbrnd" Text='<%# Eval("Brand")%>' placeholder="Brand..."  runat="server" style="width:50px; height:20px; background:none; border:none;" AutoPostBack="true"  ></asp:TextBox>
                                            ...
                                            <asp:TemplateField HeaderText="Origin">
                                                <ItemTemplate>    
                                                    <asp:TextBox ID="Tborgn" runat="server" Text='<%# Eval("Origin")%>' placeholder="Origin..."  style="width:80px; height:20px; background:none; border:none;" AutoPostBack="true" ></asp:TextBox>
                                            ...
                                            <asp:TemplateField HeaderText="Packing Size">
                                                <ItemTemplate>    
                                                    <asp:TextBox ID="TbPacksiz" runat="server" Text='<%# Eval("PackingSize")%>' placeholder="Packing size..."  style="width:80px; height:20px; background:none; border:none;" AutoPostBack="true" ></asp:TextBox>
                                            ...
                                            <asp:TemplateField HeaderText="Qty">
                                                    <ItemTemplate>    
                                                        <asp:TextBox ID="Tbqty" runat="server" Text='<%# Eval("Qty")%>' AutoPostBack="true" placeholder="Quantity..." style="width:80px; height:20px; background:none; border:none;" ></asp:TextBox>
                                                    </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Unit">
                                                <ItemTemplate>    
                                                    <asp:TextBox ID="Tbunt" runat="server" Text='<%# Eval("Unit")%>' placeholder="Unit..." style="width:80px; height:20px; background:none; border:none;" AutoPostBack="true" ></asp:TextBox>
                ...
                <div class="span12">
                    ...
                    <asp:Panel ID="pnlOutstand" runat="server">
                        <div  class="span3">
                            ...
                            <asp:TextBox runat="server" class="span12" ID="TBOutstand" Text="0.00" AutoPostBack="true"></asp:TextBox>
                        </div>
                        <div  class="span2">
                            <h5><span class="break"></span>Amount Paid:</h5>
                            <asp:TextBox runat="server" class="span12" ID="TBAmtPaid" Text="0.00" AutoPostBack="true" ></asp:TextBox>
                        </div>                   
                        <div  class="span2">
                    ...
                    <div  class="span2">
                        ...
                        <asp:TextBox runat="server" class="span12" ID="TBDiscPer" Text="0.00" AutoPostBack="true" ></asp:TextBox>
                    </div>
                    <div  class="span2">
                        <h5><span class="break"></span>Discount:</h5>
                    ...
                    <div class="span12">
                        <div class="span5">                                   
                            <asp:Button runat="server"  ID="btnSaveClose" Text="Save"  CssClass="btn btn-info"  ValidationGroup="pur"  />   
                            <asp:Button runat="server"  ID="btnRevert" Text="Cancel" CssClass="btn" />       
                        </div>                                   
                    </div>
                    <div class="span9">
