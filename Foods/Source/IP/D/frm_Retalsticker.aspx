<%@ Page Title="Retail Sticker" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="frm_Retalsticker.aspx.cs" Inherits="Foods.frm_Retalsticker" %>
				                ...
				                <div class="box-content">
                                    <asp:GridView ID="GVSticker" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="StickerName" HeaderText="Sticker Name" SortExpression="StickerName" />
                                            <asp:BoundField DataField="ProDesc" HeaderText="Item" SortExpression="ProDesc" />                                            
                                            <asp:TemplateField>
                                                <ItemTemplate>
			  ...
			  <div class="modal-dialog">
				<div class="modal-content">
                    ...
                    <tr>
                        ...
                        <td class="span8">
                            <asp:TextBox ID="TBCompany" runat="server" placeholder="Company Name.." ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="span3">
                            <asp:Label ID="lblBarcod" runat="server">Bar Code</asp:Label>
                        </td>
                        <td class="span8">
                            <asp:TextBox ID="TBBarcod" runat="server" placeholder="Bar Code.."  ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="span3">
                        ...
                        <td class="span8">
                            <asp:TextBox ID="TBProDesc" runat="server" placeholder="Product.." ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="span3">
                            <asp:Label ID="lbl_pric" runat="server">Price</asp:Label>
                        </td>
                        <td class="span8">
                            <asp:TextBox ID="TBPric" runat="server" placeholder="Price.." ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="span3">
                        ...
                        <td class="span8">
                            <asp:TextBox ID="TBSiz" runat="server" placeholder="Size.." ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="span3">
                        ...
                        <td class="span8">
                            <asp:TextBox ID="TBcolor" runat="server" placeholder="Color.." ></asp:TextBox>
                        </td>
                    </tr>
                </table>
					</div>
